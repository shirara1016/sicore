...
class SelectiveInference:
    ...
    #     match inference_mode, search_strategy:
    #         case "exhaustive" | "over_conditioning", _:
    #             if search_strategy != "pi3":
    #                 warnings.warn(
    #                     f"The search_strategy is ignored because the inference_mode is '{inference_mode}'.",
    #                     UserWarning,
    #                 )
    #             if termination_criterion != "precision":
    #                 warnings.warn(
    #                     f"The termination_criterion is ignored because the inference_mode is '{inference_mode}'.",
    #                     UserWarning,
    #                 )
    #             if n_jobs > 1:
    #                 warnings.warn(
    #                     f"The n_jobs is ignored because the inference_mode is '{inference_mode}'.",
    #                     UserWarning,
    #                 )
    #         case "parametric", "pi1" | "pi2" | "pi3":
    #             if n_jobs > 1:
    #                 warnings.warn(
    #                     f"The n_jobs is ignored because the search_strategy '{search_strategy}' is not for parallel computing.",
    #                     UserWarning,
    #                 )
    #         case "parametric", "parallel":
    #             if n_jobs == 1:
    #                 warnings.warn(
    #                     f"The search_strategy 'parallel' is not reccomened when not parallel computing (i.e., n_jobs is 1).",
    #                     UserWarning,
    #                 )

    #     if termination_criterion != "decision" and significance_level != 0.05:
    #         warnings.warn(
    #             "The significance_level is ignored because the termination_criterion is not 'decision'.",
    #             UserWarning,
    #         )
    #     if termination_criterion != "precision" and precision != 0.001:
    #         warnings.warn(
    #             "The precision is ignored because the termination_criterion is not 'precision'.",
    #             UserWarning,
    #         )
